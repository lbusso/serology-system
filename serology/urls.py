...
urlpatterns = [
    ...
    path(
        "enfermedades/nueva/", EnfermedadCreateView.as_view(), name="enfermedad_create"
    ),
    path(
        "enfermedades/<int:pk>/editar/",
        EnfermedadUpdateView.as_view(),
        name="enfermedad_update",
    ),
    path(
        "enfermedades/<int:pk>/eliminar/",
        EnfermedadDeleteView.as_view(),
        name="enfermedad_delete",
    ),
    # Tipos de Análisis
    path("tipos-analisis/", TipoAnalisisListView.as_view(), name="tipoanalisis_list"),
    path(
        "tipos-analisis/nuevo/",
        TipoAnalisisCreateView.as_view(),
        name="tipoanalisis_create",
    ),
    path(
        "tipos-analisis/<int:pk>/editar/",
        TipoAnalisisUpdateView.as_view(),
        name="tipoanalisis_update",
    ),
    path(
        "tipos-analisis/<int:pk>/eliminar/",
        TipoAnalisisDeleteView.as_view(),
        name="tipoanalisis_delete",
    ),
    # Pedidos
    ...
    path(
        "pedidos/<int:pk>/eliminar/", PedidoDeleteView.as_view(), name="pedido_delete"
    ),
    # Análisis
    ...
    path(
        "analisis/<int:pk>/editar/",
        AnalisisUpdateView.as_view(),
        name="analisis_update",
    ),
    path(
        "analisis/<int:pk>/eliminar/",
        AnalisisDeleteView.as_view(),
